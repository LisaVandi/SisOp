...
void *alfa(void *arg){
	...
	while(1){
		/* 
		 * Condizione da rispettare nel passaggio di testimone: 
		 * prima che un atleta di un gruppo possa fare il suo (n+1)-esimo giro
		 * bisogna che tutti gli altri atleti del suo stesso gruppo abbiano già fatto n giri.
		 */
