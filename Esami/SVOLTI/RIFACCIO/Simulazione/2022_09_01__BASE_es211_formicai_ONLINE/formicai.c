...
{ 
	...
	while ( 1 ) {
		/* Per cominciare il passaggio dal formicaio attuale al formicaio successivo, 
		 * il fachiro deve aspettare che il formicaio successivo sia libero 
		 * e che anche il palo sia libero */
