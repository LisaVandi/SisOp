...
{ 
	/* 
	 * Lisa IMPORTANTE: 
	 * La caratteristica del problema è che per poter prelevare, occorre che prelevino contemporaneamente
	 * mezzo buffer ciascuno un consumatore di tipo A ed uno di tipo B.
	 */
	uint64_t val;
	char Clabel[128];
