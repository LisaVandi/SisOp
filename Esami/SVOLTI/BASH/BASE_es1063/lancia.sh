...
# lancia l'esecuzione dello script contaseparatamente.sh passando allo script 
# come argomenti i primi 7 file che si ottengono come standard output del comando ls -S1 /usr/include/*.h
