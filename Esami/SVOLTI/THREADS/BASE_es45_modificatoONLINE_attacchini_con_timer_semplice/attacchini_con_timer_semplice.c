...
{ 
	...
	while(1) {
		...
		/* COMMENTI LISA: 
		 * Quando un attacchino inizia a lavorare, deve aspettare che anche l'altro attacchino cominci a lavorare.
		 * Dal momento in cui entrambi hanno cominciato a lavorare, l'unico orologio viene impostato 
		 * per avvisare gli attacchini dopo che sono passati circa 5 secondi.
		 * Al suono dell'orologio ciascun attacchino smette di lavorare e poi va via a prendere nuovi manifesti e colla, 
		 * poi torna immediatamente e cerca di ricominciare a lavorare.
		 */
