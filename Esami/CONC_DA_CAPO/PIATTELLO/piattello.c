...
{ 
	...
	DBGpthread_mutex_unlock(&mutex, Plabel); /* rilasciano la mutua esclusione per il piattello */
	...
	*/
	...
	DBGpthread_mutex_lock(&mutex, Plabel); /* il piattello prende la mutua esclusione per verificare */
