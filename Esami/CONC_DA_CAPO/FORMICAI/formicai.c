...
{ 
	...
	while ( 1 ) {
		...
		/* per transitare sul formicaio successivo, il fachiro deve prendere la mutua esclusione sul formicaio
		   poiché finchè non può prenderla, il programma rimane fermo su tale lock 
		*/
